class BannersController < ApplicationController
  ...
  private
    ...
    def banner_params
      params.require(:banner).permit(:campaign_id, :title, :utm_campaign, :utm_source, :utm_medium, :utm_content, :utm_term, :md5, :campaign_tracker, :recipients, :reference, :additional_ids)
    end
end
